...
//       document?.uri,
//     );
//     this._followRedirect = restClientSettings.get<boolean>(
//       "followredirect",
//       true,
//     );
//     this._defaultHeaders = restClientSettings.get<RequestHeaders>(
//       "defaultHeaders",
//       {
...
//       false,
//     );
//     this._rememberCookiesForSubsequentRequests =
//       restClientSettings.get<boolean>(
//         "rememberCookiesForSubsequentRequests",
//         true,
//       );
//     this._timeoutInMilliseconds = restClientSettings.get<number>(
...
//     }
//     this._excludeHostsForProxy = restClientSettings.get<string[]>(
...
//     this._mimeAndFileExtensionMapping = restClientSettings.get<{
//       [key: string]: string;
...
//       true,
//     );
//     this._hostCertificates = restClientSettings.get<HostCertificates>(
//       "certificates",
//       {},
//     );
...
//       "email",
//     ]);
//     this._disableHighlightResponseBodyForLargeResponse =
//       restClientSettings.get<boolean>(
//         "disableHighlightResponseBodyForLargeResponse",
//         true,
//       );
//     this._disableAddingHrefLinkForLargeResponse =
//       restClientSettings.get<boolean>(
...
//     );
//     this._enableTelemetry = restClientSettings.get<boolean>(
//       "enableTelemetry",
//       false,
//     );
//     this._suppressResponseBodyContentTypeValidationWarning =
//       restClientSettings.get(
//         "suppressResponseBodyContentTypeValidationWarning",
//         false,
//       );
//     this._addRequestBodyLineIndentationAroundBrackets =
//       restClientSettings.get<boolean>(
...
//       false,
//     );
//     this._logLevel = ParseLogLevelStr(
...
//       true,
//     );
//     this._enableCustomVariableReferencesCodeLens =
//       restClientSettings.get<boolean>(
...
//       brackets: this._addRequestBodyLineIndentationAroundBrackets
//         ? this.brackets
//         : [],
//     });
