...
import { ROUTER_FACTORY_NAMES, ROUTER_IDENTIFIER_PATTERN } from './trpc-constants';
 ...
 */
function isRouterishExpression(expression: Node, identifierPattern: RegExp): boolean {
